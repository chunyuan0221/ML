...
2. 影片辨識：
	* 測試一段10分鐘柯南影片，辨識出柯南的成果不是很好，近距離的臉部特徵明顯，柯南才比較容易辨識出來
	* 由於畫風緣故，會導致人物間有的臉部特徵很相似導致誤認，像是把灰原辨識為柯南
	
## 4.結論
* 本次測試時採用的label資料不多，導致在分辨上有的時候不容易偵測出柯南
* 在進行label時，要以主要特徵來進行選取，否則會導致模型在訓練時loss無法收斂
* 進行漫畫或動畫人物的辨識不同於人臉，可能因為畫風上的誇飾，導致在辨識上無法辨別，因此在資料的蒐集與label上要格外著重
* 之後可嘗試加入更多筆資料來訓練，降低avg loss
* 之後會想進行像電路板電容偵測好壞或是家庭、辦公室人員人臉辨識的事物來訓練
